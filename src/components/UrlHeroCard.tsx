    ...
    <div className="overflow-hidden rounded-lg border border-ink-200 bg-white">
      <div className="relative overflow-hidden bg-gradient-to-br from-accent-50 via-white to-white p-6 sm:p-8">
        ...
        <div className="relative flex items-start gap-4">
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-md bg-accent-600 text-white">
        ...
        <div className="relative mt-5 flex flex-col gap-2.5 sm:flex-row">
          <input
            ...
            className="flex-1 rounded-md border border-ink-300 bg-white px-3.5 py-2.5 text-sm text-ink-900 transition-colors focus:border-accent-500 focus:outline-none focus:ring-1 focus:ring-accent-500"
          />
          <button
            onClick={onSubmit}
            disabled={loading}
            className="inline-flex items-center justify-center gap-1.5 rounded-md bg-accent-600 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-accent-700 disabled:opacity-50"
          >
